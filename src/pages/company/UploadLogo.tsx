      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8">
          ...
          {preview && (
            ...
            <div className="mt-8 text-center">
              ...
              <img
                src={preview}
                alt="Preview"
                className="w-40 h-40 object-contain rounded-xl mx-auto bg-white p-3"
              />
          ...
          <button
            ...
            disabled={loading}
            className="mt-8 w-full bg-green-600 hover:bg-green-500 transition p-4 rounded-xl font-semibold"
          >
            {loading
              ? "Uploading..."
              : "Upload Logo"}
